...
def plotSingleTrace (ax, signal, SamplingRate,color='blue', Label="Signal"):
    ax.plot(signal,color,linewidth=1,label=Label,alpha=0.7)
...
def photometry_smooth_plot (raw_reference,raw_signal,sampling_rate=500, smooth_win = 10):
    ...
    lambd = 10e6 # Adjust lambda to get the best fit
    porder = 1
    itermax = 15
